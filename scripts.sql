...
ALTER TABLE CLAIM_STATUS ADD (PROCESSING_STATUS VARCHAR2(50));
ALTER TABLE CLAIM_STATUS ADD (PROCESSING_DATE TIMESTAMP);
ALTER TABLE CLAIM_STATUS ADD (AUDIT_DATE TIMESTAMP);